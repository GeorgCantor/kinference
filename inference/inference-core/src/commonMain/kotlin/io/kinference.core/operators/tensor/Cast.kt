...
class CastVer6(name: String, attributes: Map<String, Attribute<Any>>, inputs: List<String>, outputs: List<String>) : Cast(name, INFO, attributes, inputs, outputs) {
    companion object {
        ...
        private suspend fun castByte(array: ByteNDArray, to: TensorProto.DataType, context: ArrayContext? = null): NDArrayCore {
            return when (to) {
                in FLOAT_TENSOR_TYPES -> {
                    val output = context?.floatStorage?.getNDArray(array.strides) ?: FloatNDArray(FloatTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it.toFloat() }
                    output
                }

                TensorProto.DataType.UINT8 -> {
                    val output = context?.uByteStorage?.getNDArray(array.strides) ?: UByteNDArray(UByteTiledArray(array.shape), array.strides)
                ...
                TensorProto.DataType.UINT16 -> {
                    val output = context?.uShortStorage?.getNDArray(array.strides) ?: UShortNDArray(UShortTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it.toUShort() }
                    output
                }

                TensorProto.DataType.INT16 -> {
                    val output = context?.shortStorage?.getNDArray(array.strides) ?: ShortNDArray(ShortTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it.toShort() }
                    output
                }

                TensorProto.DataType.INT32 -> {
                    val output = context?.intStorage?.getNDArray(array.strides) ?: IntNDArray(IntTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it.toInt() }
                    output
                }

                TensorProto.DataType.INT64 -> {
                    val output = context?.longStorage?.getNDArray(array.strides) ?: LongNDArray(LongTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it.toLong() }
                    output
                }

                TensorProto.DataType.BOOL -> {
                    val output = context?.booleanStorage?.getNDArray(array.strides) ?: BooleanNDArray(BooleanTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it != (0).toByte() }
                    output
                }

                TensorProto.DataType.DOUBLE -> {
                    val output = context?.doubleStorage?.getNDArray(array.strides) ?: DoubleNDArray(DoubleTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it.toDouble() }
                    output
                }

                TensorProto.DataType.UINT32 -> {
                    val output = context?.uIntStorage?.getNDArray(array.strides) ?: UIntNDArray(UIntTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it.toUInt() }
                    output
                }

                TensorProto.DataType.UINT64 -> {
                    val output = context?.uLongStorage?.getNDArray(array.strides) ?: ULongNDArray(ULongTiledArray(array.shape), array.strides)
        ...
        private suspend fun castShort(array: ShortNDArray, to: TensorProto.DataType, context: ArrayContext? = null): NDArrayCore {
            return when (to) {
                in FLOAT_TENSOR_TYPES -> {
                    val output = context?.floatStorage?.getNDArray(array.strides) ?: FloatNDArray(FloatTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it.toFloat() }
                ...
                TensorProto.DataType.INT8 -> {
                    val output = context?.byteStorage?.getNDArray(array.strides) ?: ByteNDArray(ByteTiledArray(array.shape), array.strides)
        ...
        private suspend fun castInt(array: IntNDArray, to: TensorProto.DataType, context: ArrayContext? = null): NDArrayCore {
            return when (to) {
                in FLOAT_TENSOR_TYPES -> {
                    val output = context?.floatStorage?.getNDArray(array.strides) ?: FloatNDArray(FloatTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it.toFloat() }
        ...
        private suspend fun castLong(array: LongNDArray, to: TensorProto.DataType, context: ArrayContext? = null): NDArrayCore {
            return when (to) {
                in FLOAT_TENSOR_TYPES -> {
                    val output = context?.floatStorage?.getNDArray(array.strides) ?: FloatNDArray(FloatTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it.toFloat() }
        ...
        private suspend fun castUByte(array: UByteNDArray, to: TensorProto.DataType, context: ArrayContext? = null): NDArrayCore {
            return when (to) {
                in FLOAT_TENSOR_TYPES -> {
                    val output = context?.floatStorage?.getNDArray(array.strides) ?: FloatNDArray(FloatTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it.toFloat() }
        ...
        private suspend fun castUShort(array: UShortNDArray, to: TensorProto.DataType, context: ArrayContext? = null): NDArrayCore {
            return when (to) {
                in FLOAT_TENSOR_TYPES -> {
                    val output = context?.floatStorage?.getNDArray(array.strides) ?: FloatNDArray(FloatTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it.toFloat() }
        ...
        private suspend fun castUInt(array: UIntNDArray, to: TensorProto.DataType, context: ArrayContext? = null): NDArrayCore {
            return when (to) {
                in FLOAT_TENSOR_TYPES -> {
                    val output = context?.floatStorage?.getNDArray(array.strides) ?: FloatNDArray(FloatTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it.toFloat() }
        ...
        private suspend fun castULong(array: ULongNDArray, to: TensorProto.DataType, context: ArrayContext? = null): NDArrayCore {
            return when (to) {
                in FLOAT_TENSOR_TYPES -> {
                    val output = context?.floatStorage?.getNDArray(array.strides) ?: FloatNDArray(FloatTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it.toFloat() }
        ...
        private suspend fun castFloat(array: FloatNDArray, to: TensorProto.DataType, context: ArrayContext? = null): NDArrayCore {
            return when (to) {
        ...
        private suspend fun castDouble(array: DoubleNDArray, to: TensorProto.DataType, context: ArrayContext? = null): NDArrayCore {
            return when (to) {
                in FLOAT_TENSOR_TYPES -> {
                    val output = context?.floatStorage?.getNDArray(array.strides) ?: FloatNDArray(FloatTiledArray(array.shape), array.strides)
                    array.array.pointer().mapTo(output.array.pointer(), array.linearSize) { it.toFloat() }
        ...
        private suspend fun castBoolean(array: BooleanNDArray, to: TensorProto.DataType, context: ArrayContext? = null): NDArrayCore {
            return when (to) {
                in FLOAT_TENSOR_TYPES -> {
                    val output = context?.floatStorage?.getNDArray(array.strides) ?: FloatNDArray(FloatTiledArray(array.shape), array.strides)
        ...
        internal suspend fun castTo(input: NDArrayCore, to: TensorProto.DataType, context: ArrayContext? = null): NDArrayCore {
    ...
    override suspend fun <D : ONNXData<*, *>> apply(contexts: Contexts<D>, inputs: List<KITensor?>): List<KITensor?> {
        ...
        val casted = castTo(tensor.data, to, arrayContext)

        return listOf(casted.asTensor("output", arrayContext))
    }
}
